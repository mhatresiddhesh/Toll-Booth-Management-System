...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="center" class="auto-style3" style="border-style: solid; background-color: #CCFFFF; width: 1100px;">
        <tr>
            <td class="auto-style5" colspan="3" align="center"><strong style="text-align: center">USER REGISTRATION</strong></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="auto-style9" align="center" style="color: #FF0000">* <asp:DropDownList ID="DropDownListGender" runat="server" Height="25px" Width="150px">
        ...
        <tr>
            ...
            <td class="auto-style14" style="color: #FF0000">
                *
                <asp:TextBox ID="TextBoxAddress" runat="server" Height="25px" Width="220px" placeholder="Enter Full Address"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBoxAddress" ErrorMessage="* Address field cannot be empty" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            ...
            <td class="auto-style15" style="color: #FF0000">
                *
                <asp:TextBox ID="TextBoxDob" runat="server" Height="25px" Width="220px" placeholder="DD-MM-YYYY"></asp:TextBox>
            </td>
            <td class="auto-style12">
        ...
        <tr>
            <td class="auto-style13">Vehicle Details (Primary):</td>
            <td class="auto-style14" style="color: #FF0000">
                *
                <asp:TextBox ID="TextBoxVehicle1" runat="server" Height="25px" Width="220px" MaxLength="10" placeholder="E.g. AB00CD0000"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="TextBoxVehicle1" ErrorMessage="* Vehicle Details (Primary) field cannot be empty" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="auto-style19">Vehicle Details (Secondary/Optional):</td>
            <td class="auto-style20" style="color: #FF0000">
                *
                <asp:TextBox ID="TextBoxVehicle2" runat="server" Height="25px" Width="220px" MaxLength="10" placeholder="E.g. AB00CD0000"></asp:TextBox>
                </td>
            <td class="auto-style21">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="TextBoxVehicle2" ErrorMessage="* Enter &quot;0&quot; if Vehicle Details (Secondary) does not exist " ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style10">Account Balance:</td>
            <td class="auto-style15" style="color: #FF0000">
                *
                <asp:TextBox ID="TextBoxBalance" runat="server" Height="25px" TextMode="Number" Width="220px" placeholder="Enter Amount"></asp:TextBox>
            </td>
            <td class="auto-style12">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="TextBoxBalance" ErrorMessage="* Enter Amount. Minimum Balance should be Rs.200 " ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style22" colspan="3" align="center">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/LoginPage.aspx">Already have an account, LOGIN now!</asp:HyperLink>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style4" colspan="3" align="center" style="color: #FF0000">
